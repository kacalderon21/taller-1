...
public class Automata1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            if (i < c.length() && c.charAt(i) == '1') // Símbolo '1', desde q0 a q2
            {
                i++; //Mueve el índice al siguiente símbolo en la cadena

            }else {
                
                if (i < c.length() && c.charAt(i) == '0') // Símbolo '0', desde q0 a q1
                {
                    i++; //Mueve el índice al siguiente símbolo en la cadena

                    while (i < c.length() && c.charAt(i) == '0') //Bucle '0' en q1
                    {
                        i++; //Mueve el índice al siguiente símbolo en la cadena
                    }

                    if (i < c.length() && c.charAt(i) == '1') //Símbolo '1', desde q1 a q2
                    {
                        i++; //Mueve el índice al siguiente símbolo en la cadena
                        ...
                        if (i < c.length() && c.charAt(i) == '0') //Símbolo '0', desde q2 a q3
                    {
                        ...
                        while (i < c.length() && c.charAt(i) == '0') //Bucle '0' en q3
                    {
                        i++; //Mueve el índice al siguiente símbolo en la cadena
                    }
                        if (i < c.length() && c.charAt(i) == '1') //Símbolo '1', desde q3 a q4
                    {
                        i++; //Mueve el índice al siguiente símbolo en la cadena
